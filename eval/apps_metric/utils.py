...
def evaluate_generations(
    generations: list, level: str = "all", split: str = "test", debug: bool = False
):
    ...
    apps_eval = load_dataset(DATASET, split=split, difficulties=[level])
    results = {}
    for index in trange(len(generations)):
...
if __name__ == "__main__":
    with open("/home/shizhongyi/paper_code/inference_results/vanilla_CodeQwen/APPS-testset-stat.json", "r") as f:
        results = json.load(f)
